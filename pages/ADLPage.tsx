...
const ADLPage: React.FC<ADLPageProps> = ({ onNavigate }) => {

    const actionCards = [
        { id: 'importar', icon: ImportIcon, title: 'Importar' },
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse text-sm">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                ...
                <span className="ms-1 font-medium text-slate-400 dark:text-slate-500 md:ms-2">ADL</span>
              </div>
            </li>
          </ol>
        </nav>
